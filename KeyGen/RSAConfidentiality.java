...
public class RSAConfidentiality {
    public static void main(String[] args) throws Exception {
        byte[] input =
                "x012340123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF".getBytes();
...
//block is always 128 Bytes (1024 bits) long.
        ...
        System.out.println("plainText (" + plainText.length +" bytes): " + new
                String(plainText) + "\n");
